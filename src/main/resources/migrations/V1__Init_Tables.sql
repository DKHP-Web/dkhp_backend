...
create table registration (course_id integer not null, student_id integer not null, primary key (course_id, student_id)) engine=InnoDB;
create table registration_period (id integer not null auto_increment, close_time datetime(6), open_time datetime(6), semester_id varchar(255), primary key (id)) engine=InnoDB;
...
create table subject_relation (curr_subject_id integer not null, pre_subject_id integer not null, type tinyint check (type between 0 and 1), primary key (curr_subject_id, pre_subject_id)) engine=InnoDB;
